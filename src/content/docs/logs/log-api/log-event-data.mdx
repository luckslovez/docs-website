...
<DoNotTranslate>**Additional storage:**</DoNotTranslate>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        These attributes are reserved for our browser and mobile agents, for internal use. These are not advised to be used in custom events.
      </td>
    </tr>
